...
最終更新: 2026-09-24 08:46 JST / 表示: 最新 6 件（最大 200 件）

| 実行日時 (JST) | job_id | status | video_id | youtube_url | 1h metrics | 24h metrics | analysis | improvement_actions | failed_stage | error |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 2026-09-24 08:37:27 | [`yt-1194-1790206647599`](https://github.com/ikkinotako2-sketch/project-love-machine/blob/plm-results/pipeline-results/yt-1194-1790206647599.json) | succeeded | nRuOrJEG6so | [動画](https://www.youtube.com/watch?v=nRuOrJEG6so) | 未取得 | 未取得 | — | — | — | — |
